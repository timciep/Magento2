...
class Interceptor extends \Magento\Sitemap\Controller\Adminhtml\Sitemap\Delete implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Sitemap\Model\SitemapFactory $sitemapFactory = null)
    {
        $this->___init();
        parent::__construct($context, $sitemapFactory);
    }
